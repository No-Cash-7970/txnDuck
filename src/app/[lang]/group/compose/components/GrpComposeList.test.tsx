...
describe('Compose Form Component', () => {
  ...
  it('shows "No transactions" when there are no transaction slots', async () => {
  ...
  it('loads all saved transactions slots in group', async () => {
  ...
  it('disables "Add transaction slot" button when there are 16 (the max) slots', async () => {
